  ...
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-5xl sm:text-6xl font-bold text-pink-700 mb-4">
          Featured
        </h2>
            ...
            >
              {featuredProducts?.map((product) => (
                <div key={product._id} className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex-shrink-0 px-2">
                  <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-gray-300">
                    <div className="overflow-hidden">
                      <img
                    ...
                    <div className="p-4">
					  ...
					  <h3 className="text-s font-semibold mb-2 text-black">{product.description}</h3>
                      <p className="text-red-700 font-medium mb-4">${product.price.toFixed(2)}</p>
                      <button
