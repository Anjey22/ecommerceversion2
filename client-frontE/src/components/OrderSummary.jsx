...
const stripePromise = loadStripe(
	"pk_test_51PNzdq2Mp1mGrLqyo6oNs14Jg4cdq3KE8E6i6HEj0Lk9L8bpYze92uUxmYCmqU5PIPnm3RXAQJOTVqUphYZUPswM00NBJVAfXR"
		...
		>
			...
			<div className='space-y-4'>
				...
				<div className='flex items-center justify-center gap-2'>
					...
					<Link
						to='/'
						className='inline-flex items-center gap-2 text-sm font-medium text-gray-600 underline hover:text-black hover:no-underline'
					>
						Continue Shopping
						<MoveRight size={16} />
					</Link>
